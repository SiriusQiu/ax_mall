...
import org.linlinjava.ax.db.service.AxGoodsProductService;
import org.linlinjava.ax.db.service.AxOrderGoodsService;
...
public class OrderJob {
    ...
    public void checkOrderUnpaid() {
        ...
        List<AxOrder> orderList = orderService.queryUnpaid(SystemConfig.getOrderUnpaid());
        for (AxOrder order : orderList) {
            // 设置订单已取消状态
    ...
    public void checkOrderUnconfirm() {
        ...
        List<AxOrder> orderList = orderService.queryUnconfirm(SystemConfig.getOrderUnconfirm());
        for (AxOrder order : orderList) {
    ...
    public void checkOrderComment() {
        ...
        List<AxOrder> orderList = orderService.queryComment(SystemConfig.getOrderComment());
        for (AxOrder order : orderList) {
