...
ax = Spring Boot后端 + Vue管理员前端 + 微信小程序用户前端 + Vue用户移动端

* [文档](https://linlinjava.gitbook.io/ax)
* [贡献](https://linlinjava.gitbook.io/ax/contribute)
* [FAQ](https://linlinjava.gitbook.io/ax/faq)
* [API](https://linlinjava.gitbook.io/ax/api)
...
* [码云](https://gitee.com/linlinjava/ax)
* [GitHub](https://github.com/linlinjava/ax)
...
3. 启动小商场和管理后台的后端服务
    ...
    mvn install
    mvn clean package
    java -Dfile.encoding=UTF-8 -jar ax-all/target/ax-all-0.1.0-exec.jar
    ```
...
5. 启动小商城前端
   ...
   这里存在两套小商场前端ax-wx和renard-wx，开发者可以分别导入和测试：
   ...
   > 更详细方案请参考[文档](https://linlinjava.gitbook.io/ax/project)。
...
当前版本[v1.4.0](https://linlinjava.gitbook.io/ax/changelog)
 ...
 * 如果真的需要QQ群里提问，请在提问前先完成以下过程：
    * 请仔细阅读本项目文档，特别是是[**FAQ**](https://linlinjava.gitbook.io/ax/faq)，查看能否解决；
...
[MIT](https://github.com/linlinjava/ax/blob/master/LICENSE)
